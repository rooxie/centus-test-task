...
<ul>
    @if($weatherAlert->pecepitation > 0)
        <li>Pecepitation >={{ $weatherAlert->pecepitation }}.</li>
    @endif
    @if($weatherAlert->pecepitation > 0)
        <li>UV index >={{ $weatherAlert->uv }}.</li>
    @endif
</ul>
...
<ul>
    ...
    <li>Perciptation: {{ $weatherReport->getPrecipitation() }}%</li>
